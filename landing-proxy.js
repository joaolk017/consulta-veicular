    ...
    <section id="inicio" class="cv-hero">
      ...
      <div class="cv-shell cv-hero-grid">
        ...
        <aside class="cv-crlv-hero" aria-label="Emissão de CRLV-e SP">
          <div class="cv-crlv-hero-top">
            <span class="cv-crlv-icon">📄</span>
            <div>
              <span class="cv-crlv-state">SÃO PAULO · SP</span>
              <h2>Emissão de<br><strong>CRLV-e SP</strong></h2>
            </div>
          </div>
          <p class="cv-crlv-hero-lead">Solicitação privada para obtenção do CRLV-e em PDF de veículo registrado no Estado de São Paulo.</p>

          <div class="cv-crlv-hero-features">
            <div><b>✓</b><span><strong>Documento em PDF</strong><small>Pronto para salvar ou imprimir quando disponibilizado.</small></span></div>
            <div><b>✓</b><span><strong>Solicitação protegida</strong><small>Validação de dados, finalidade e autorização.</small></span></div>
            <div><b>✓</b><span><strong>Processo online</strong><small>Inicie a solicitação diretamente pelo site.</small></span></div>
          </div>

          <div class="cv-crlv-hero-price">
            <span>Valor do serviço privado</span>
            <strong>R$ 59,90</strong>
          </div>

          <button class="cv-crlv-hero-btn" type="button" onclick="abrirCRLVCV()">📄 EMITIR CRLV-e SP AGORA</button>
          <div class="cv-crlv-hero-note">Somente para proprietário do veículo ou pessoa com autorização legítima. Serviço privado e independente; não somos DETRAN-SP, SENATRAN ou GOV.BR.</div>
        </aside>
      </div>
      ...
      <div class="cv-trustbar">
        ...
        <div><b>CRLV-e SP</b><span>Solicitação com validação e autorização</span></div>
      </div>
    </section>
...
.cv-shell{width:min(1200px,92vw);margin:auto}
.cv-nav{position:fixed;z-index:90;top:0;left:0;right:0;height:72px;display:flex;align-items:center;gap:28px;padding:0 max(4vw,22px);background:rgba(4,10,20,.94);border-bottom:1px solid rgba(106,174,255,.14);backdrop-filter:blur(14px)}
...
.cv-hero{position:relative;min-height:860px;padding:112px 0 118px;overflow:hidden;background:#06101e}.cv-hero:before{content:"";position:absolute;inset:0;background-image:url('ChatGPT%20Image%2016%20de%20set.%20de%202026,%2012_01_50.png?v=10');background-size:cover;background-position:center;opacity:.18;filter:saturate(.9)}.cv-hero-overlay{position:absolute;inset:0;background:radial-gradient(circle at 78% 33%,rgba(28,130,255,.24),transparent 30%),linear-gradient(90deg,#040a14 0%,rgba(4,10,20,.93) 48%,rgba(4,10,20,.76) 100%)}
.cv-hero-grid{position:relative;z-index:4;display:grid;grid-template-columns:minmax(0,.92fr) minmax(420px,.88fr);gap:52px;align-items:center;min-height:620px}.cv-hero-left{display:grid;gap:26px}.cv-kicker{display:inline-block;color:#58b9ff;font-size:11px;font-weight:950;letter-spacing:1.7px}.cv-hero-copy h1{margin:15px 0 18px;font-size:clamp(45px,5.2vw,70px);line-height:.98;letter-spacing:-3px}.cv-hero-copy h1 em{font-style:normal;color:#2f9fff}.cv-hero-copy>p{max-width:600px;margin:0;color:#a8b8cc;font-size:16px;line-height:1.7}.cv-badges{display:flex;flex-wrap:wrap;gap:9px;margin-top:22px}.cv-badges span{padding:8px 11px;border:1px solid #243a56;border-radius:999px;background:#0b1727;color:#d5dfeb;font-size:11px;font-weight:800}
.cv-search-card{max-width:560px;padding:22px;border:1px solid #2a537e;border-radius:20px;background:linear-gradient(180deg,rgba(12,27,46,.97),rgba(7,16,29,.98));box-shadow:0 28px 85px rgba(0,0,0,.5)}.cv-search-label{color:#59baff;font-size:10px;font-weight:950;letter-spacing:1.6px}.cv-search-card h2{margin:7px 0 5px;font-size:23px}.cv-search-card>p{margin:0 0 14px;color:#8496ac;font-size:12px}.cv-search-card input{width:100%;height:55px;border:1px solid #dce5ed;border-radius:12px;background:#f7f9fb;color:#101820;outline:0;padding:0 15px;text-align:center;text-transform:uppercase;font-size:24px;font-weight:950;letter-spacing:4px}.cv-search-card input:focus{box-shadow:0 0 0 4px rgba(39,145,245,.18)}.cv-search-card button{width:100%!important;height:52px;margin:10px 0 0!important;border:0!important;border-radius:12px!important;background:linear-gradient(135deg,#1c98ff,#0866db)!important;color:#fff!important;font-size:14px!important;font-weight:950!important;box-shadow:0 13px 32px rgba(15,117,229,.3)!important;cursor:pointer}.cv-search-card button:disabled{opacity:.6}.cv-error{min-height:16px;margin-top:5px;color:#ffbbc5;text-align:center;font-size:11px;font-weight:800}.cv-price-line{display:flex;justify-content:space-between;align-items:center;margin-top:8px;padding-top:12px;border-top:1px solid #21344a;color:#8fa0b4;font-size:12px}.cv-price-line strong{color:#fff;font-size:21px}.cv-safe{margin-top:8px;color:#708399;font-size:9px;line-height:1.4}
.cv-crlv-hero{position:relative;padding:34px;border:1px solid rgba(74,159,255,.8);border-radius:28px;background:radial-gradient(circle at 80% 0,rgba(36,133,245,.26),transparent 35%),linear-gradient(180deg,rgba(13,43,75,.98),rgba(6,19,34,.99));box-shadow:0 35px 100px rgba(0,0,0,.55),0 0 45px rgba(20,120,235,.15);overflow:hidden}.cv-crlv-hero:after{content:"";position:absolute;right:-70px;bottom:-90px;width:240px;height:240px;border-radius:50%;background:rgba(31,132,246,.08)}.cv-crlv-hero-top{position:relative;z-index:2;display:flex;align-items:flex-start;gap:18px}.cv-crlv-icon{display:grid;place-items:center;width:66px;height:66px;flex:0 0 auto;border:1px solid #3f80c4;border-radius:18px;background:#102f51;font-size:32px;box-shadow:0 14px 34px rgba(0,0,0,.25)}.cv-crlv-state{color:#78c5ff;font-size:11px;font-weight:950;letter-spacing:1.5px}.cv-crlv-hero h2{margin:5px 0 0;font-size:clamp(35px,4vw,54px);line-height:.98;letter-spacing:-2px}.cv-crlv-hero h2 strong{color:#55b8ff}.cv-crlv-hero-lead{position:relative;z-index:2;margin:22px 0;color:#b2c3d6;font-size:14px;line-height:1.65}.cv-crlv-hero-features{position:relative;z-index:2;display:grid;gap:9px}.cv-crlv-hero-features>div{display:flex;gap:10px;align-items:flex-start;padding:12px 13px;border:1px solid #284766;border-radius:13px;background:rgba(4,18,32,.7)}.cv-crlv-hero-features>div>b{display:grid;place-items:center;width:22px;height:22px;border-radius:50%;background:#0f6ab4;color:#fff;font-size:12px}.cv-crlv-hero-features span{display:grid;gap:3px}.cv-crlv-hero-features strong{font-size:12px}.cv-crlv-hero-features small{color:#8499b0;font-size:10px;line-height:1.4}.cv-crlv-hero-price{position:relative;z-index:2;display:flex;justify-content:space-between;align-items:end;margin:20px 0 13px;padding-top:18px;border-top:1px solid #29445f}.cv-crlv-hero-price span{color:#8ca2b9;font-size:11px}.cv-crlv-hero-price strong{font-size:43px;line-height:1}.cv-crlv-hero-btn{position:relative;z-index:2;width:100%!important;margin:0!important;padding:17px!important;border:0!important;border-radius:13px!important;background:linear-gradient(135deg,#2b96ff,#1358b6)!important;color:#fff!important;font-size:15px!important;font-weight:950!important;box-shadow:0 15px 35px rgba(26,109,210,.32)!important;cursor:pointer}.cv-crlv-hero-note{position:relative;z-index:2;margin-top:11px;color:#71869c;font-size:9px;line-height:1.5;text-align:center}
.cv-trustbar{position:absolute;z-index:5;left:50%;bottom:18px;transform:translateX(-50%);width:min(1080px,90vw);display:grid;grid-template-columns:repeat(3,1fr);gap:1px;overflow:hidden;border:1px solid #1d3148;border-radius:15px;background:#1d3148}.cv-trustbar div{padding:12px 18px;background:rgba(6,16,28,.95)}.cv-trustbar b{display:block;font-size:11px}.cv-trustbar span{color:#75889e;font-size:9px}
...
@media(max-width:1000px){.cv-links{display:none}.cv-nav{padding:0 18px}.cv-nav-btn{margin-left:auto}.cv-hero{min-height:auto;padding:108px 0 130px}.cv-hero-grid{grid-template-columns:1fr;gap:32px}.cv-hero-left{gap:22px}.cv-search-card{max-width:none}.cv-crlv-hero{padding:28px}.cv-trustbar{bottom:14px}.cv-cards{grid-template-columns:repeat(2,1fr)}.cv-crlv-grid{grid-template-columns:1fr;gap:28px}.cv-faq-grid{grid-template-columns:1fr;gap:28px}.cv-left-heading{text-align:center;margin:auto}.cv-footer-grid{grid-template-columns:1fr;text-align:center;gap:14px}.cv-footer-grid>div:nth-child(2){justify-content:center}}
@media(max-width:560px){.cv-nav{height:62px}.cv-brand span:last-child{font-size:14px}.cv-nav-btn{padding:9px 10px;font-size:9px}.cv-hero{padding:92px 0 118px}.cv-hero:before{background-position:62% center;opacity:.12}.cv-hero-grid{gap:22px}.cv-hero-copy h1{font-size:41px;letter-spacing:-2px}.cv-hero-copy>p{font-size:14px}.cv-badges{gap:6px}.cv-badges span{font-size:9px}.cv-search-card{padding:17px;border-radius:17px}.cv-search-card h2{font-size:20px}.cv-search-card input{height:50px;font-size:21px}.cv-search-card button{height:49px}.cv-crlv-hero{padding:21px;border-radius:21px}.cv-crlv-icon{width:52px;height:52px;font-size:26px}.cv-crlv-hero h2{font-size:34px}.cv-crlv-hero-lead{font-size:12px;margin:17px 0}.cv-crlv-hero-features>div{padding:10px}.cv-crlv-hero-price strong{font-size:36px}.cv-crlv-hero-btn{font-size:13px!important;padding:15px!important}.cv-trustbar{width:92vw;grid-template-columns:1fr}.cv-trustbar div:nth-child(2),.cv-trustbar div:nth-child(3){display:none}.cv-section{padding:65px 0}.cv-cards{grid-template-columns:1fr}.cv-steps{grid-template-columns:1fr}.cv-heading h2{font-size:32px}.cv-trust-cards{grid-template-columns:1fr}.cv-crlv-card strong{font-size:36px}}
...
async function start(){
  ...
  server.listen(PUBLIC_PORT,()=>console.log(`Landing page com CRLV-e em destaque na porta ${PUBLIC_PORT}`));
}
